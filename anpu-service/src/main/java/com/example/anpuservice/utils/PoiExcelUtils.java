...
/**
 * FileName: com.iyingke.riskbackstage.utils.PoiExcelUtils.java
...
public class PoiExcelUtils {
    ...
    //构造方法，传入要导出的数据
    public PoiExcelUtils(String title, String[] rowName, List<Object[]> dataList) {
                    ...
                    if (currentRow.getCell(colNum) != null) {
                        ...
                        if (currentCell != null) {
                            if (currentCell.getCellType() == HSSFCell.CELL_TYPE_STRING) {
                                HSSFRichTextString richStringCellValue = currentCell.getRichStringCellValue();
